  ...
  return (
    <>
      ...
      <main className="pt-24 pb-20 bg-brand-cream min-h-screen">
        {/* HERO */}
        <section className="bg-emerald-950 py-16 sm:py-20 text-white relative overflow-hidden">
          <div className="absolute top-0 right-0 w-1/2 h-full bg-brand-gold/10 skew-x-12 transform translate-x-20"></div>
          <div className="container mx-auto px-4 relative z-10 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white font-heading" dangerouslySetInnerHTML={{ __html: cms['about.hero.title'] || 'About <span class="text-brand-gold">My Property Centre</span>' }} />
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <span className="text-[10px] uppercase tracking-widest font-bold text-brand-gold block mb-2">Our Purpose</span>
                <h2 className="text-3xl font-bold mb-4 font-heading">{cms['about.mission.title'] || 'Our Mission'}</h2>
                ...
                <p className="text-zinc-600 leading-relaxed font-bold text-emerald-950">
                  {cms['about.mission.p3'] || 'My Property Centre was built to solve this. We act as your secure bridge, vetting every developer, handling the legalities, and ensuring your capital is deployed safely into assets that appreciate.'}
                </p>
              </div>
        ...
        <section className="py-12 md:py-16 bg-zinc-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-2">
              <span className="text-[10px] uppercase tracking-widest font-bold text-brand-gold">Value Proposition</span>
            </div>
            <h2 className="text-3xl font-bold text-center mb-10 font-heading">Why Partner With Us?</h2>
        ...
        {/* CTA */}
        <section className="py-12 md:py-16 bg-brand-cream text-center">
          <div className="container mx-auto px-4">
            <div className="text-center mb-2">
              <span className="text-[10px] uppercase tracking-widest font-bold text-brand-gold">Get Started</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-heading">Ready to Build Your Portfolio?</h2>
